## My Implementation of the matrix.h library functions on School-21
...
- The library code located in the src folder on the develop branch;   
- Made it as a static library named *s21_matrix.a* (with the s21_matrix.h header file);
